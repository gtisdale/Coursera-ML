...
### Executive Summary
In this discussion I present the development of a random forest model for predicting Human Activity based on acceleromter data.  The final model has an accuracy better than 96%.
